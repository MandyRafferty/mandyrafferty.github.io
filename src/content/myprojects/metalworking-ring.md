...
categories: ["Metalworking", "Investment Casting"]
tags: ["Metalworking"]
thumbnail: '/images/IC Ring/8-carved.jpg'
---

## Fabrication Process
- File wax to desired size and shape
- Add sprue and attach to flask base, then pour in plaster
- Insert molten metal into investment casting using a centrifugal casting machine
- Carve and polish to achieve final product

<div class="slideshow">
  <div class="slides">
    <div class="slide active">
      <img src="/images/IC Ring/1-wax.jpg" alt="Image 1">
    </div>
    <div class="slide">
      <img src="/images/IC Ring/2-wax_carved.jpg" alt="Image 2">
      <div class="caption">Carve wax to size and general shape of ring</div>
    </div>
    <div class="slide">
      <img src="/images/IC Ring/3-sprue.jpg" alt="Image 3">
      <div class="caption">Create sprue to suspend wax in plaster</div>
    </div>
    <div class="slide">
      <img src="/images/IC Ring/4-base.jpg" alt="Image 4">
      <div class="caption">Attach wax to base of flask</div>
    </div>
    <div class="slide">
      <img src="/images/IC Ring/5-flask.jpg" alt="Image 5">
    </div>
    <div class="slide">
      <img src="/images/IC Ring/6-melt.jpg" alt="Image 6">
      <div class="caption">Melt metal to put into the casting</div>
    </div>
    <div class="slide">
      <img src="/images/IC Ring/7-casting.jpg" alt="Image 7">
      <div class="caption">Centrigual casting machine</div>
    </div>
    <div class="slide">
      <img src="/images/IC Ring/8-carved.jpg" alt="Image 8">
      <div class="caption">Carve and polish casted piece</div>
    </div>
    <div class="slide">
      <img src="/images/IC Ring/9-final.jpg" alt="Image 9">
    </div>
</div>
  ...
  <div class="thumbnails">
    <img src="/images/IC Ring/1-wax.jpg" alt="Thumbnail 1" onclick="currentSlide(0)" class="thumbnail active">
    <img src="/images/IC Ring/2-wax_carved.jpg" alt="Thumbnail 2" onclick="currentSlide(1)" class="thumbnail">
    <img src="/images/IC Ring/3-sprue.jpg" alt="Thumbnail 3" onclick="currentSlide(2)" class="thumbnail">
    <img src="/images/IC Ring/4-base.jpg" alt="Image 4" onclick="currentSlide(3)" class="thumbnail">
    <img src="/images/IC Ring/5-flask.jpg" alt="Image 5" onclick="currentSlide(4)" class="thumbnail">
    <img src="/images/IC Ring/6-melt.jpg" alt="Image 6" onclick="currentSlide(5)" class="thumbnail">
    <img src="/images/IC Ring/7-casting.jpg" alt="Image 7" onclick="currentSlide(6)" class="thumbnail">
    <img src="/images/IC Ring/8-carved.jpg" alt="Image 8" onclick="currentSlide(7)" class="thumbnail">
    <img src="/images/IC Ring/9-final.jpg" alt="Image 9" onclick="currentSlide(8)" class="thumbnail">
  </div>
</div>
...
<div class="photo-row" style="display: flex; justify-content: center;">
  <figure>
    <img src="/images/IC Ring/8-carved.jpg" alt="Final pic 1">
  </figure>
  <figure>
    <img src="/images/IC Ring/9-final.jpg" alt="Final pic 2">
  </figure>
</div>
